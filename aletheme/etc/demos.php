...
class ale_demo_content extends ale_demo_base {
    ...
    static function add_post($params) {
        ...
        if(!empty($params['ale_discount_service'])){
            update_post_meta($post_id, 'ale_discount_service', ale_demo_media::get_image_url_by_ale_id($params['ale_discount_service']));
        }

        //Projects

        if(!empty($params['ale_projects_subtitle'])){
            update_post_meta($post_id, 'ale_projects_subtitle', $params['ale_projects_subtitle']);
        }
        if(!empty($params['ale_projects_name'])){
            update_post_meta($post_id, 'ale_projects_name', $params['ale_projects_name']);
        }
        if(!empty($params['ale_projects_date'])){
            update_post_meta($post_id, 'ale_projects_date', $params['ale_projects_date']);
        }
        ...
        if(!empty($params['ale_service_description_image'])){
            update_post_meta($post_id, 'ale_service_description_image', $params['ale_service_description_image']);
        }
        if(!empty($params['ale_gardener_title'])){
            update_post_meta($post_id, 'ale_gardener_title', $params['ale_gardener_title']);
        }
        ...
        if(!empty($params['ale_service_lebel_one'])){
            update_post_meta($post_id, 'ale_service_lebel_one', $params['ale_service_lebel_one']);
        }
        if(!empty($params['ale_service_link_two'])){
            update_post_meta($post_id, 'ale_service_link_two', $params['ale_service_link_two']);
        }
        if(!empty($params['ale_service_lebel_two'])){
            update_post_meta($post_id, 'ale_service_lebel_two', $params['ale_service_lebel_two']);
        }
        if(!empty($params['ale_service_link_three'])){
            update_post_meta($post_id, 'ale_service_link_three', $params['ale_service_link_three']);
        }
        if(!empty($params['ale_service_lebel_three'])){
            update_post_meta($post_id, 'ale_service_lebel_three', $params['ale_service_lebel_three']);
        }
        ...
        if(!empty($params['ale_partners_sub_title'])){
            update_post_meta($post_id, 'ale_partners_sub_title', $params['ale_partners_sub_title']);
        }
        if(!empty($params['ale_partners_title_site'])){
            update_post_meta($post_id, 'ale_partners_title_site', $params['ale_partners_title_site']);
        }
        if(!empty($params['ale_partners_link_site'])){
            update_post_meta($post_id, 'ale_partners_link_site', $params['ale_partners_link_site']);
        }

        //Testimonials

        if(!empty($params['ale_testi_position'])){
            update_post_meta($post_id, 'ale_testi_position', $params['ale_testi_position']);
        }
        if(!empty($params['ale_testi_rating'])){
            update_post_meta($post_id, 'ale_testi_rating', $params['ale_testi_rating']);
        }
        if(!empty($params['ale_testi_subtitle'])){
            update_post_meta($post_id, 'ale_testi_subtitle', $params['ale_testi_subtitle']);
        }
    ...
    static function add_page($params) {
        ...
        //Contacts page
        if(!empty($params['ale_phone_label'])){
            update_post_meta($page_id, 'ale_phone_label', $params['ale_phone_label']);
        }
    ...
    //About Us page
        ...
        if(!empty($params['ale_partners_info'])){
            update_post_meta($page_id, 'ale_partners_info', $params['ale_partners_info']);
        }
        ...
        if(!empty($params['ale_services_title'])){
            update_post_meta($page_id, 'ale_services_title', $params['ale_services_title']);
        }
        if(!empty($params['ale_pertners_bg'])){
            update_post_meta($page_id, 'ale_pertners_bg', ale_demo_media::get_image_url_by_ale_id($params['ale_pertners_bg']));
        }
