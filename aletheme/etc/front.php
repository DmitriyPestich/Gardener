...
<<?php echo esc_attr($tag) ?> <?php comment_class(empty( $args['has_children'] ) ? '' : 'parent') ?> id="comment-<?php comment_ID() ?>">
    ...
    <?php } ?>
        ...
        <div class="comment-box">
            <div class="info-meta">
                <span class='author font_two'><?php echo get_comment_author();?></span>
                <span class="comment_date font_one"><?php printf( ale_wp_kses(esc_html__('%1$s %2$s','gardener')), get_comment_time(), get_comment_date() ) ?></span>
