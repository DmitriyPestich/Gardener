	...
	foreach ( $options as $value ) {
		...
		if ( ( $value['type'] != "heading" ) && ( $value['type'] != "info" ) ) {
			...
			if ( isset( $value['name'] ) ) {
			    ...
			    if(isset( $value['tutorial'])){
                    $output .= '<h4 class="heading">' . esc_html( $value['name'] ) . ' <a href="'.esc_html($value['tutorial']).'" target="_blank" style=" color:#cc181e; text-decoration:none; float:right">'.esc_html__('Video Tutorial','gardener').' &nbsp;<i class="fa fa-youtube-play" style="font-size:1.2em;" aria-hidden="true"></i></a></h4>' . "\n";
                } else {
		...
		case 'typography':
			...
			if ( $typography_options['sizes'] ) {
				$font_size = '<div class="ale_setting_line cf"><div class="half-box"><div class="ale_setting_title">'. esc_html__('Font Size:','gardener').'</div><select class="of-typography of-typography-size" name="' . esc_attr( $option_name . '[' . $value['id'] . '][size]' ) . '" id="' . esc_attr( $value['id'] . '_size' ) . '">';
			...
			if ( $typography_options['faces'] ) {
				$font_face = '<div class="half-box cf"><div class="ale_setting_title">'. esc_html__('The Font:','gardener').'</div><select class="of-typography of-typography-face" name="' . esc_attr( $option_name . '[' . $value['id'] . '][face]' ) . '" id="' . esc_attr( $value['id'] . '_face' ) . '">';
			...
			if ( $typography_options['styles'] ) {
				$font_style = '<div class="ale_setting_line cf"><div class="half-box"><div class="ale_setting_title">'. esc_html__('Font Style:','gardener').'</div><select class="of-typography of-typography-style" name="'.$option_name.'['.$value['id'].'][style]" id="'. $value['id'].'_style">';
			...
			if ( $typography_options['transform'] ) {
				$font_transform = '<div class="half-box cf"><div class="ale_setting_title">'. esc_html__('Font Transform:','gardener').'</div><select class="of-typography of-typography-transform" name="'.$option_name.'['.$value['id'].'][transform]" id="'. $value['id'].'_transform">';
			...
			if ( $typography_options['weight'] ) {
				$font_weight = '<div class="ale_setting_line cf"><div class="half-box"><div class="ale_setting_title">'. esc_html__('Font Weight:','gardener').'</div><select class="of-typography of-typography-weight" name="'.$option_name.'['.$value['id'].'][weight]" id="'. $value['id'].'_weight">';
		...
		case 'background':
			...
			case 'header_styles':
				...
				// Header BG Color
				$output .= '<div class="ale_setting_line cf"><div class="half-box"><div class="ale_setting_title">'. esc_html__('Header Background Color:','gardener').'</div>';
				...
				// Text Color
				$output .= '<div class="half-box cf"><div class="ale_setting_title">'. esc_html__('Text Color:','gardener').'</div>';
				...
				// Background Image - New AJAX Uploader using Media Library
				$output .= '<div class="ale_setting_line cf"><div class="ale_setting_title">'.esc_html__('Header Background Image:','gardener').'</div> ';
				...
				// Header Width
				$output .= '<div class="ale_setting_line cf"><div class="half-box"><div class="ale_setting_title">'. esc_html__('Width (px):','gardener').'</div>';
				...
				// Header Height
				$output .= '<div class="half-box cf"><div class="ale_setting_title">'. esc_html__('Height (px):','gardener').'</div>';
				...
				// Content Alignment
				$output .= '<div class="ale_setting_line cf"><div class="ale_setting_title">'. esc_html__('Content Align:','gardener').'</div>';
