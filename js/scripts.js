jQuery(function($) {
    ...
    //Home Form Tabs Categories
    if($('.form_categoris .services_categoris').length){
        $('.service_category_li_item').on('click',function(){
            var current_button = $(this).data('cat');
            $('.service_category_li_item').removeClass('active');
            $(this).addClass('active');
            $('.category_hidden_field').val(current_button);
        })
    }

    if($('.service_prise_item').length){
        var selectedItem = $('.service_prise_item.selected').data('title');

        $('h3.form_service_title').text(selectedItem);
        $('.label_form_service_title').val(selectedItem);

        $('.service_prise_item .left_part').on('click', function(){
            $('.service_prise_item').removeClass('selected');
    ...
    if($('.gardener_slide').length){
        $('.gardener_slide').slick({
            autoplay: true,
            pauseOnHover: true,
            adaptiveHeight: true,
            //arrows: false,
    ...
    $(".item_box_service").on('click', function(){
        var selected_button = $(this).data('id');

        $(".item_service").addClass('display_none').removeClass('display');
        $(".services_image .image").addClass('display_none').removeClass('display');

        $('.item_service[data-id="'+selected_button+'"]').removeClass('display_none').addClass('display');
        $('.services_image .image[data-id="'+selected_button+'"]').removeClass('display_none').addClass('display');

        $(this).on('hover').addClass('hover_image');

    });

    $(".data_container").on('click', function(){
        $(".data_container").removeClass('popup_button');
        $(this).addClass('popup_button');
    });
    ...
    if($('.left_box').length){
        ...
        $('.left_box').on('init', function(event, slick){
        ...
        $('.left_box').on('afterChange', function(event, slick){
           var currentIndex = $('.left_box').slick('slickCurrentSlide');
    ...
    $('.top').click(function(){
        $('.left_box').slick('slickPrev');
    })

    $('.bottom').click(function(){
        $('.left_box').slick('slickNext');
    })

    if($('.testiomnials_slider_box').length){
        $('.testiomnials_slider_box').slick({
            arrows: false,
            fade: true
        });
        var $carousel =  $('.testiomnials_slider_box');
        $(document).on('keydown', function(e) {
            if(e.keyCode == 37) {
                $carousel.slick('slickPrev');
            }
        ...
        $('.prev').click(function(){
            $('.testiomnials_slider_box').slick('slickPrev');
        })

        $('.next').click(function(){
            $('.testiomnials_slider_box').slick('slickNext');
        })
    }
    ...
    if($('.portfolio_slider').length){
        ...
        $('.button_slide_projects .left').click(function(){
            $('.portfolio_slider').slick('slickPrev');
        })

        $('.button_slide_projects .right').click(function(){
            $('.portfolio_slider').slick('slickNext');
        })

        $('.portfolio_slider').on('afterChange', function(event, slick){
            var currentIndex = $('.portfolio_slider').slick('slickCurrentSlide');
