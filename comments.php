...
?>
<div class="comment_section wrapper">
<!-- Comments -->
    ...
    <div id="respond" class="leave-a-comment">
        <div class="comments_name cf">
            <div class="comments_title">
                <h3><?php esc_html_e('Leave a comment','gardener');?> <?php echo cancel_comment_reply_link(); ?></h3>
                <div class="title_comment_label">Please, fill the fields below</div>
            </div>
        </div>
        ...
        <?php else : ?>
            <form action="<?php echo esc_url(get_option('siteurl')); ?>/wp-comments-post.php" id="comment-form" method="post" class="comment-form cf">
                ...
                <?php if (!is_user_logged_in()) : ?>
                <div class="line-item cf font_one">
                    ...
                    <div class="third_item">
                        <input type="email" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" tabindex="3" <?php if ($req) echo "aria-required='true'"; ?> required="required" email="true" placeholder="<?php esc_html_e('Your e-mail*','gardener'); ?>" />
                    </div>
                ...
                <div class="line-item comment_container ">
                    <textarea id="message" name="comment" tabindex="1" class="message font_one" required="required" placeholder="<?php esc_html_e('Type here your comment','gardener'); ?>"></textarea>
                </div>

                <div class="line-item submit_container cf font_one">
